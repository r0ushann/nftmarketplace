...
const Artworks = () => {
  return (
    <div className="gradient-bg-artworks pt-5">
      <div className="w-4/5 py-10 mx-auto mt-20 mb-15">
        <h4 className="text-white text-4xl font-bold uppercase text-gradient2">
          Latest Artworks
        </h4>

        <div className="grid grid-cols-1 mt-10 md:grid-cols-3 lg:grid-cols-4 gap-8 md:gap-6 lg:gap-4 py-3 px-2">
          {Array(8)
            .fill()
            .map((nft, i) => (
              <Card key={i} nft={nft} />
  ...
  <div className="w-full bg-gray-800 my-3 p-4 shadow-md shadow-green-600 rounded-md overflow-hidden">
    ...
    <div className="flex justify-between items-center mt-3">
      <div className="flex flex-col">
        <small className="text-green-400 font-bold text-xs">
        Current Price :
        </small>
